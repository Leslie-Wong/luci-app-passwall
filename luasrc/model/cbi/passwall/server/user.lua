...
tls.validate = function(self, value, t)
	if value then
		...
		local reality = reality:formvalue(t) or 0
...
reality_show = s:option(Flag, "show", translate("show"))
reality_show.default = 0
reality_show:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })

reality_dest = s:option(Value, "dest", translate("dest"))
reality_dest.default = ""
reality_dest:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })

reality_xver = s:option(Value, "xver", translate("xver"))
reality_xver.default = ""
reality_xver:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })

reality_servername = s:option(Value, "servername", translate("servername"))
reality_servername.default = ""
reality_servername:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })

reality_privateKey = s:option(Value, "privateKey", translate("privateKey"))
reality_privateKey.default = ""
reality_privateKey:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })

reality_shortids = s:option(Value, "shortIds", translate("shortIds"))
reality_shortids.default = ""
reality_shortids:depends({ reality = "Xray", protocol = "vless", tls = true, reality = "1" })
